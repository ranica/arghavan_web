...
demo = {
    changeMiniBar: function () {
        $body = $('body');
        $input = $('.switch-sidebar-mini input');
    ...
    initMaterialWizard: function () {
        ...
        var $validator = $('.wizard-card form')
            .validate({
                rules: {
                    firstname: {
                        required: true,
        ...
        function refreshAnimation($wizard, index) {
            $total = $wizard.find('.nav li')
                .length;
            $li_width = 100 / $total;

            total_steps = $wizard.find('.nav li')
                .length;
            move_distance = $wizard.width() / total_steps;
            index_temp = index;
            vertical_level = 0;

            mobile_device = $(document)
                .width() < 600 && $total > 3;
            ...
            $wizard.find('.moving-tab')
                .css('width', step_width);
            $('.moving-tab')
                .css({
     ...
     * Show Notification
     */
    showNotification: (message, type, delay = 1500, from = 'top', align = 'right') => {
