                    ...
                    <div class="card-content">
                        ...
                        <h3 class="card-title">
                            <div>
                                ...
                                <span class="panel-heading">بستگان دانشجو</span>

                                @can('command_insert')
                                <span class="pull-left" v-show="isNormalMode">
                                    <a class="btn btn-primary" href="#" @click.prevent="newRecord">
...
@endsection 
@section('scripts')
<script type="text/javascript" src="{{ mix('js/pages/relatives/index.js') }}"></script>
@endsection
