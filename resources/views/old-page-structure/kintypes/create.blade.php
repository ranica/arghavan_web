        ...
        <div class="card-content f-BYekan">
            <form>
                ...
                <div class="form-group label-floating mrg-top-2em" :class="{'has-error' : errors.has('name')}">
                    ...
                    <input autofocus required class="form-control" type="text" name="name"
                    minlength="2" maxlength="50"
                    v-model="tempRecord.name"
                    v-validate="'required|min:2|max:50'"
                    data-vv-delay="250"
                    data-vv-name ="نام نسبت" />

                    <i v-show="errors.has('name')" class="fa fa-warning"></i>
                    <span v-show="errors.has('name')" class="help is-danger">نام نسبت نامعتبر می باشد</span>
