			...
			<form>
				...
				<div class="form-group label-floating" :class="{'has-error' : errors.has('name')}">
					...
					<input class="form-control" type="text"  name="name" minlength="2" maxlength="50"
						autofocus required v-validate="'required|min:2|max:50'" data-vv-delay="250"
						v-model="tempRecord.name"
						data-vv-name ="نوع کارت"
						/>
					<i v-show="errors.has('name')" class="fa fa-warning"></i>
                    <span v-show="errors.has('name')" class="help is-danger">نوع کارت نامعتبر می باشد</span>
