    ...
    class TrafficValidate : Validator
    {
                                     ...
                                     Dictionary<string, object> criterial)
        {
            ...
            if (0 == result)
            {
                ...
                int opResult = lGateTraffic.RegisterTraffic(baseRecord, Convert.ToInt16(dataRecord["user_id"]), criterial, messageId);
                                     ...
                                     int message_id)
        {
            ...
            int opResult = lGateTraffic.RegisterTraffic(baseRecord, Convert.ToInt16(dataRecord["user_id"]), criterial, message_id);
