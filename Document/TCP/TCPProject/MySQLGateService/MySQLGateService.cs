...
namespace MySQLGateService
{
    public partial class MySQLGateService : ServiceBase
    {
        ...
        private MySQLGateServer gServer = null;
		...
		private void connectToGate()
        {
            ...
            gServer = new MySQLGateServer(prtServer, C_BufferSize);
        ...
        //{
        //    IPEndPoint remoteIpEndPoint = client.Client.Client.LocalEndPoint as IPEndPoint;
        //    writeLog("INF: " + remoteIpEndPoint.Address + "- > Receive: " + Encoding.UTF8.GetString(data.model as byte[]));
        //    Helper.ClientMethodParser.parseCmd(client, data, prt);
        //}
