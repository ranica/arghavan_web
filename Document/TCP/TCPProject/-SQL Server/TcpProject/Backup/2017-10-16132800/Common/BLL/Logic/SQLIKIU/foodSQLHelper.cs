...
namespace Common.BLL.Logic.SQLIKIU
{
	public class foodSQLHelper
	{
        ...
        {
            SqlConnection connection	= new SqlConnection(ConfigurationManager.AppSettings["ConnectionString"].Trim());
        ...
        {
            SqlCommand  cmd		= new SqlCommand();
            SqlConnection conn	= new SqlConnection(ConfigurationManager.AppSettings["ConnectionString"].Trim());
