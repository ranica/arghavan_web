...
namespace TcpProjectSQL.Helper
{
    public class GateClientSQL
    {
        ...
        #region Methods
        public GateClientSQL(string host, int port, int bufferSize)
        {
            prepare();
        ...
        private int ValidateData(int typeDirect, string ip, string commandGate)
        {
            ...
            string kart = Convert.ToString((Int64.Parse(commandGate.Substring(5, 8), System.Globalization.NumberStyles.HexNumber)));
            ...
            else
            {
                ...
                dic.Add("serviceId", serviceUser.id);
                dic.Add("cdn", kart);
            ...
            if (0 != resultValidate)
            {
                ...
                CommandResult opResult = lGateTraffic.RegisterTraffic(resultBase.Rows[0], resultData.Rows[0], dic, resultValidate);
            }
