    ...
    class TrafficValidate : Validator
    {
                                     ...
                                     Dictionary<string, object> criterial)
        {
            ...
            if (0 == result)
            {
                ...
                CommandResult opResult = lGateTraffic.RegisterTraffic(baseRecord, dataRecord, criterial, messageId);
                                     ...
                                     int message_id)
        {
            ...
            CommandResult opResult = lGateTraffic.RegisterTraffic(baseRecord, dataRecord, criterial, message_id);
