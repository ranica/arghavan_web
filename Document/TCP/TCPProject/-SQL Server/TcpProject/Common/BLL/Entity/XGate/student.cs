...
{
	[Serializable]
	public class student : BaseBLL.Entity.BaseByViewId
	{
		
	
//
	// Genereted Property of id
	//
	#region Referenced Property - user
		BLL.Entity.XGate.user _user_id;
		public BLL.Entity.XGate.user user_id
		{
			get
			{
				if ((null == _user_id) && (AutoLoadForeignKeys))
					load_user_id ();
				return _user_id;
			}
			set
		...
		{ 
			...
			entity	= new BLL.Entity.XGate.user () { id = id };
		...
		public Nullable<System.Byte> native
		{
			get;
			set;
		}
		...
		public Nullable<System.Int32> degree_id
		{
			get;
			set;
		}
		...
		[BaseBLL.Base.Field(nullable=true,sqlDBType=System.Data.SqlDbType.Int,primary=false,usage=BaseBLL.Base.EnumUsage.read | BaseBLL.Base.EnumUsage.update | BaseBLL.Base.EnumUsage.create)]
		public Nullable<System.Int32> field_id
		{
			get;
			set;
		}
		...
		[BaseBLL.Base.Field(nullable=true,sqlDBType=System.Data.SqlDbType.Int,primary=false,usage=BaseBLL.Base.EnumUsage.read | BaseBLL.Base.EnumUsage.update | BaseBLL.Base.EnumUsage.create)]
		public Nullable<System.Int32> part_id
		{
			get;
			set;
		}
		...
		public System.Int32 situation_id
		{
			get;
			set;
		}
...
//
	...
	#region Referenced Property - gateoperator
		...
		public System.Int32 updated_id
		{
			get;
			set;
		}
//
	...
	#region Referenced Property - gateoperator
		...
		public BLL.Entity.XGate.gateoperator gateoperator_updated_id
		{
			get
			{
				if ((null == _gateoperator_updated_id) && (AutoLoadForeignKeys))
		...
		{ 
			...
			entity	= new BLL.Entity.XGate.gateoperator () { id = updated_id };
			logic	= new BLL.Logic.XGate.gateoperator ("XGate");
			logic.read (entity);
