...
namespace Common.BLL.Logic.IAU
{
	public class gatetraffic 
	{
        ...
        /// <returns></returns>
        public int RegisterTraffic(DataRow baseRecord, DataRow dataRecord, Dictionary<string, object> criterial, int message_id)
        {
            int result = -1;
            ...
            MySqlParameter[] parameters =
              {
                    new MySqlParameter(PARAM_USER_ID, dataRecord["user_id"]),
            ...
            /// <returns></returns>
            public bool UpdateResponseTraffic(string host, Dictionary<string, UserFeature> dicUser, bool pass)
            {
                ...
                MySqlParameter[] parameters =
                 ...
                 // UPDATE traffic
                 return MySQLHelper.ExecuteNonQuery(CommandType.StoredProcedure, C_spUpdateResponseTraffic, parameters) != 0;
