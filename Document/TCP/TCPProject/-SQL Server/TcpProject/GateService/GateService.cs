...
namespace GateService
{
	public partial class GateService : ServiceBase
	{
        ...
        /// </summary>
		public const string C_GATE_EVENT_SOURCE	= "IAUGateService";
		
		/// <summary>
        /// Gate Event Log name 
        /// </summary>
		public const string C_GATE_EVENT_LOG	= "IAUGateServiceLog";
		...
		private void TcpClient_onReceiveData (NetTcpClient sender, CommandResult data)
		{
		...
		/// <param name="sender"></param>
		/// <param name="data"></param>
		private void TcpClient_onSendData (NetTcpClient sender, CommandResult data)
		{
		...
		/// <param name="sender"></param>
		/// <param name="data"></param>
		private void TcpClient_onError (NetTcpClient sender, CommandResult data)
		{
